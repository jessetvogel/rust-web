...
// impl Page {
//     pub fn new(path: &str, element: Elem) -> Self {
//         Self {
//             path: path.to_owned(),
//             element,
//             title: None,
...
//         let body = Js::invoke("return document.querySelector({})", &[root.into()])
//             .to_ref()
//             .unwrap();
//         let pathname = Js::invoke("return window.location.pathname", &[])
//             .to_str()
//             .unwrap();
//         let page = pages
//             .iter()
...
//         let mut pages = pages
//             .iter()
//             .map(|p| (p.path.clone(), p.to_owned()))
//             .collect::<Vec<_>>();
//         pages.push((default_page.path.clone(), default_page.to_owned()));
//         Self {
//             pages: HashMap::from_iter(pages),
//             root: Some(body),
//         }
//     }
