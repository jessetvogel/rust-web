...
impl El {
    pub fn new(tag: &str) -> Self {
        let el = Js::invoke_ref("return document.createElement({})", &[Str(tag)]);
    ...
    pub fn mount(&self, parent: &ObjectRef) {
        Js::invoke("{}.appendChild({})", &[Ref(&parent), Ref(&self)]);
    }
    pub fn unmount(&self) {
    ...
    pub fn attr(self, name: &str, value: &str) -> Self {
        Js::invoke("{}.setAttribute({},{})", &[Ref(&self), Str(name), Str(value)]);
        self
    }
    ...
    pub fn classes(self, classes: &[&str]) -> Self {
        classes.iter().for_each(|c| { Js::invoke("{}.classList.add({})", &[Ref(&self), Str(c)]); });
        self
    }
    ...
    pub fn children(self, children: &[Self]) -> Self {
        Js::invoke("{}.innerHTML = {}", &[Ref(&self), Str("")]);
    ...
    pub fn text(self, text: &str) -> Self {
        ...
        let el = Js::invoke_ref("return document.createTextNode({})", &[Str(text)]);
